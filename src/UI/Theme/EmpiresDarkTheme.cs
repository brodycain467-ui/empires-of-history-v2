...
namespace EmpiresOfHistory.UI.Theme
{
    /// <summary>
    ...
    ///
    /// Call Build() once at startup and assign the result to the root Control's Theme property.
    /// </summary>
    public static class EmpiresDarkTheme
    {
        // ── Palette constants ──────────────────────────────────────────────────────────

        public static readonly Color Background    = new Color("#1a1208");
        public static readonly Color PanelSurface  = new Color("#2a1f0e");
        public static readonly Color GoldAccent    = new Color("#c9a84c");
        public static readonly Color TextPrimary   = new Color("#f0e6cc");
        public static readonly Color TextSecondary = new Color("#a08060");
        public static readonly Color OceanColor    = new Color("#0d1b2a");
        public static readonly Color ButtonCta     = new Color("#8b6914");
        public static readonly Color ButtonDanger  = new Color("#8b1414");
        ...
        public static Godot.Theme Build()
        {
            ...
            // ── Panel ──────────────────────────────────────────────────────────────────
            var panelStyle = MakeFlatBox(PanelSurface, BorderSubtle, cornerRadius: 2);
            ...
            // ── Button (default) ───────────────────────────────────────────────────────
            var btnNormal = MakeFlatBox(PanelSurface, BorderSubtle, cornerRadius: 2);
            var btnHover  = MakeFlatBox(PanelSurface.Lightened(0.12f), new Color(GoldAccent.R, GoldAccent.G, GoldAccent.B, 0.6f), cornerRadius: 2);
            var btnPress  = MakeFlatBox(PanelSurface.Darkened(0.08f), GoldAccent, cornerRadius: 2);
            var btnFocus  = MakeFlatBox(PanelSurface, GoldAccent, cornerRadius: 2);
            ...
            theme.SetStylebox("disabled", "Button", MakeFlatBox(PanelSurface.Darkened(0.2f), new Color(0.4f, 0.4f, 0.4f, 0.25f), cornerRadius: 2));
